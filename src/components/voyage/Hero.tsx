...
const Hero = () => {
  ...
  return (
    <section className="min-h-[75vh] flex flex-col justify-center px-16 pt-40 pb-24 relative overflow-hidden bg-ink max-md:px-6 max-md:pb-20 max-md:min-h-[80vh] max-md:pt-32">
      <div
      ...
      <div className="relative z-10 max-w-[700px]">
        ...
        <div className="flex gap-4 flex-wrap animate-fade-up-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-transparent border border-voyage-white/25 text-voyage-white/80 font-medium text-[0.78rem] tracking-[0.1em] uppercase rounded-xs hover:border-gold hover:text-gold hover:-translate-y-0.5 transition-all"
          >
            {t("hero.howItWorks")}
          </button>
        </div>

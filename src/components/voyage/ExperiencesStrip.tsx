...
const experiences = [
  ...
  { icon: "🛳️", title: "Cruises", desc: "River cruises, ocean voyages, luxury yachts. I find the sailing that suits you." },
...
const ExperiencesStrip = () => (
  <section className="py-28 px-16 bg-voyage-white max-md:px-6 max-md:py-16" id="experiences">
    <ScrollReveal>
      <div className="text-[0.65rem] font-semibold tracking-[0.22em] uppercase text-gold mb-3">What I can arrange</div>
    </ScrollReveal>
    <ScrollReveal>

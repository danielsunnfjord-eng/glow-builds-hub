...
const About = () => {
  ...
  return (
    <div>
      ...
      <section className="pt-32 pb-20 px-16 bg-ink relative overflow-hidden max-lg:px-10 max-md:px-6 max-md:pt-28 max-md:pb-14">
        ...
        <div className="relative z-10 flex items-center gap-12 max-md:flex-col max-md:gap-8">
          ...
          <div className="w-56 h-56 rounded-full overflow-hidden border-2 border-gold/40 shadow-[0_10px_40px_rgba(169,198,193,0.18)] flex-shrink-0 max-md:w-44 max-md:h-44">

...
Rewrite the prose the way an experienced, well-travelled human advisor would speak to a trusted client over a coffee. The writing must feel personal, grounded and real — never like it was generated by an AI. Preserve every heading, list, emphasis mark, link, image and paragraph break from the input exactly; only rewrite the prose inside that structure.
...
— Vary sentence length and rhythm. Short sentences are welcome.`,
